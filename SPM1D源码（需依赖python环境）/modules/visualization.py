...
def plot_k2_result(spm_result, inference_result, ax=None, save_path=None, group_name=None):
    ...
    ax.plot(x, k2_values, color='black', linewidth=2, label='K2 statistic')
    ax.axhline(y=zstar, color='red', linestyle='--', linewidth=1.5, label=f'Critical: {zstar:.4f}')
    ax.fill_between(x, zstar, k2_values, where=(k2_values > zstar), color='red', alpha=0.3,
                    label='Non-normal region')
