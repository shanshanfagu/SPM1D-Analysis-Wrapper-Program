...
class TabImport(QWidget):
    ...
    def load_data(self):
        ...
        try:
            ...
            QMessageBox.information(self, self.main_window.tr("common.success"), 
                                  self.main_window.tr("tab_import.success_loaded"))

        except Exception as e:
            QMessageBox.critical(self, self.main_window.tr("common.error"), 
    ...
    def update_preview(self, data):
        ...
        self.data_info.setText(
            f"{self.main_window.tr('tab_import.loaded')} {len(data)} {self.main_window.tr('tab_import.indicators')}, "
            f"{self.main_window.tr('tab_import.total')} {total_samples} {self.main_window.tr('tab_import.samples')}, "
            f"{total_timepoints} {self.main_window.tr('tab_import.timepoints')}"
        )
