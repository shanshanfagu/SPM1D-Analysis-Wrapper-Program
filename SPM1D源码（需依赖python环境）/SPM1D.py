...
class MainWindow(QMainWindow):
    ...
    def retranslate_ui(self):
        ...
        for i in range(self.tab_widget.count()):
            tab_name_keys = ["tabs.about", "tabs.import", "tabs.normality", 
    ...
    def setup_statusbar(self):
        self.statusBar().showMessage(self.tr("main.ready"))
        self.statusBar().addPermanentWidget(QLabel("SPM1D Analyzer v1.2"))
    ...
    def show_about(self):
        QMessageBox.about(self, self.tr("main.about_title"), self.tr("main.about_text"))

    def closeEvent(self, event):
        reply = QMessageBox.question(self, self.tr("main.confirm_exit"),
                                     self.tr("main.confirm_exit_msg"),
